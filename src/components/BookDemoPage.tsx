    ...
    <div className="min-h-screen pt-20 sm:pt-32 pb-16 px-3 sm:px-4 bg-gradient-to-br from-white via-gray-50 to-white">
      <div className="max-w-2xl mx-auto">
        ...
        {confirmation === null && (
          ...
          >
            <div className="flex justify-between mb-6 sm:mb-8 gap-1 sm:gap-2">
              {[
                ...
                <div key={item.step} className="flex items-center flex-1 min-w-0">
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-semibold transition-all duration-300 flex-shrink-0 ${
                  ...
                  <p className="text-xs sm:text-sm font-medium text-gray-600 ml-1 sm:ml-2 truncate hidden sm:block">
                    {item.label}
                  </p>

                  {index < 3 && (
                    <div
                      className="flex-1 h-0.5 mx-1 sm:mx-3 bg-gray-200"
                      aria-hidden="true"
                    />
                  )}
                </div>
        ...
        >
          ...
          {currentStep === 'expert' && (
            <Card className="p-4 sm:p-6 md:p-8 border-gray-200">
                  ...
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-[var(--accent-blue-end)] font-medium truncate">
                          {expert.title}
                        </p>
              ...
              {formErrors.expertId && (
                <p className="text-red-500 text-xs sm:text-sm mb-4 flex items-center gap-1">
                  <AlertCircle className="w-4 h-4 flex-shrink-0" />
                  {formErrors.expertId}
                </p>
              )}
            ...
            <Card className="p-4 sm:p-6 md:p-8 border-gray-200 border-green-500 bg-green-50">
              <div className="text-center">
                ...
                <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 text-left space-y-2 sm:space-y-3">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-gray-600">Expert</p>
                    <p className="font-semibold text-xs sm:text-sm text-gray-900">
                ...
                <Button
                  onClick={resetForm}
                  className="w-full gradient-primary text-white py-2.5 sm:py-3 rounded-xl sm:rounded-2xl text-sm sm:text-base"
                >
                  Book Another Demo
                </Button>
              </div>
